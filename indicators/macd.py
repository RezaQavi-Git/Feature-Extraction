...
def macd(df):
    ...
    signal_cross_0_above = cross_value_from_above(macd_value['MACDs_12_26_9'], 0)
    signal_cross_0_bottom = cross_value_from_bottom(macd_value['MACDs_12_26_9'], 0)

    value_top_signal = up_down_line(macd_value['MACD_12_26_9'], macd_value['MACDs_12_26_9'])
    signal_top_value = up_down_line(macd_value['MACDs_12_26_9'], macd_value['MACD_12_26_9'])

    cross_signal_bullish = cross_line_bullish(macd_value['MACD_12_26_9'], macd_value['MACDs_12_26_9'])
    cross_signal_bearish = cross_line_bearish(macd_value['MACD_12_26_9'], macd_value['MACDs_12_26_9'])
    d = {
        'macd_value': macd_value['MACD_12_26_9'],
        'macd_signal': macd_value['MACDs_12_26_9'],
